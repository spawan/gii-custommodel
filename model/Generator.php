...
namespace frontend\codiant\model;
use Yii;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $baseClass1 = 'yii\db\ActiveRecord';
    ...
    {
        return ['model.php','base_model.php','query.php'];
    }
    ...
    public function generate()
    {
        ...
        if (!file_exists(Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/query/' . $className . 'Query.php')) {
         $files[] = new CodeFile(
                Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/query/' . $className . 'Query.php',
